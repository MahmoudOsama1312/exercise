                    ...
                    <div className='row'>
                        <div className='col-lg-4 col-md-12 col-sm-12 py-3'>
                            <div className='content'>
                                <h5 className='location text-uppercase'> Location</h5>
                                <p className='lead'>2215 John Daniel DriveClark, MO 65243</p>
                            </div>
                        </div>
                        <div className='col-lg-4 col-md-12 col-sm-12 py-3'>
                            <div className='content'>
                                <h5 className='around text-uppercase'> Around the Web</h5>
                        ...
                        <div className='col-lg-4 col-md-12 col-sm-12 py-3'>
                            <div className='content'>
                                <h5 className='location text-uppercase'> about Freelancing</h5>
